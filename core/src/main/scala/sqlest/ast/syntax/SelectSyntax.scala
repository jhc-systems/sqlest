...
trait SelectSyntax {
  ...
  def from(from: Relation) = Select(HNil, from = from)

  /** Select a subset of columns from a relation: `select(...).from(...)`. */
  def apply = SelectBuilder(HNil)

  def apply[C1](column1: AliasedColumn[C1]) = SelectBuilder(column1 :: HNil)

  def apply[C1, C2](column1: AliasedColumn[C1], column2: AliasedColumn[C2]) = SelectBuilder(column1 :: column2 :: HNil)

  def apply[C1, C2, C3](column1: AliasedColumn[C1], column2: AliasedColumn[C2], column3: AliasedColumn[C3]) = SelectBuilder(column1 :: column2 :: column3 :: HNil)

  def apply[C1, C2, C3, C4](column1: AliasedColumn[C1], column2: AliasedColumn[C2], column3: AliasedColumn[C3], column4: AliasedColumn[C4]) = SelectBuilder(column1 :: column2 :: column3 :: column4 :: HNil)

  def apply[C1, C2, C3, C4, C5](column1: AliasedColumn[C1], column2: AliasedColumn[C2], column3: AliasedColumn[C3], column4: AliasedColumn[C4], column5: AliasedColumn[C5]) = SelectBuilder(column1 :: column2 :: column3 :: column4 :: column5 :: HNil)

  def apply[C1, C2, C3, C4, C5, C6](column1: AliasedColumn[C1], column2: AliasedColumn[C2], column3: AliasedColumn[C3], column4: AliasedColumn[C4], column5: AliasedColumn[C5], column6: AliasedColumn[C6]) = SelectBuilder(column1 :: column2 :: column3 :: column4 :: column5 :: column6 :: HNil)

  def apply[C1, C2, C3, C4, C5, C6, C7](column1: AliasedColumn[C1], column2: AliasedColumn[C2], column3: AliasedColumn[C3], column4: AliasedColumn[C4], column5: AliasedColumn[C5], column6: AliasedColumn[C6], column7: AliasedColumn[C7]) = SelectBuilder(column1 :: column2 :: column3 :: column4 :: column5 :: column6 :: column7 :: HNil)

  def apply[C1, C2, C3, C4, C5, C6, C7, C8](column1: AliasedColumn[C1], column2: AliasedColumn[C2], column3: AliasedColumn[C3], column4: AliasedColumn[C4], column5: AliasedColumn[C5], column6: AliasedColumn[C6], column7: AliasedColumn[C7], column8: AliasedColumn[C8]) = SelectBuilder(column1 :: column2 :: column3 :: column4 :: column5 :: column6 :: column7 :: column8 :: HNil)

  def apply[C1, C2, C3, C4, C5, C6, C7, C8, C9](column1: AliasedColumn[C1], column2: AliasedColumn[C2], column3: AliasedColumn[C3], column4: AliasedColumn[C4], column5: AliasedColumn[C5], column6: AliasedColumn[C6], column7: AliasedColumn[C7], column8: AliasedColumn[C8], column9: AliasedColumn[C9]) = SelectBuilder(column1 :: column2 :: column3 :: column4 :: column5 :: column6 :: column7 :: column8 :: column9 :: HNil)

  def apply[C1, C2, C3, C4, C5, C6, C7, C8, C9, C10](column1: AliasedColumn[C1], column2: AliasedColumn[C2], column3: AliasedColumn[C3], column4: AliasedColumn[C4], column5: AliasedColumn[C5], column6: AliasedColumn[C6], column7: AliasedColumn[C7], column8: AliasedColumn[C8], column9: AliasedColumn[C9], column10: AliasedColumn[C10]) = SelectBuilder(column1 :: column2 :: column3 :: column4 :: column5 :: column6 :: column7 :: column8 :: column9 :: column10 :: HNil)
