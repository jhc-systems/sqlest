...
object ColumnTypeEquivalence {
  implicit def baseBaseEquivalence[A](implicit left: ColumnType[A], right: ColumnType[A], nonNumeric: ColumnType[A] with NonNumericColumnType) =
    ColumnTypeEquivalence(left, right)

  implicit def baseOptionEquivalence[A](implicit left: ColumnType[A], right: ColumnType[Option[A]], nonNumeric: ColumnType[A] with NonNumericColumnType) =
    ColumnTypeEquivalence(left, right)

  implicit def optionBaseEquivalence[A](implicit left: ColumnType[Option[A]], right: ColumnType[A], nonNumeric: ColumnType[A] with NonNumericColumnType) =
    ColumnTypeEquivalence(left, right)

  implicit def optionOptionEquivalence[A](implicit left: ColumnType[Option[A]], right: ColumnType[Option[A]], nonNumeric: ColumnType[A] with NonNumericColumnType) =
    ColumnTypeEquivalence(left, right)

  implicit def baseBaseNumericEquivalence[A, B](implicit left: ColumnType[A], right: ColumnType[B], leftNumeric: ColumnType[A] with NumericColumnType, rightNumeric: ColumnType[B] with NumericColumnType) =
    ColumnTypeEquivalence(left, right)

  implicit def baseOptionNumericEquivalence[A, B](implicit left: ColumnType[A], right: ColumnType[Option[B]], leftNumeric: ColumnType[A] with NumericColumnType, rightNumeric: ColumnType[B] with NumericColumnType) =
    ColumnTypeEquivalence(left, right)

  implicit def optionBaseNumericEquivalence[A, B](implicit left: ColumnType[Option[A]], right: ColumnType[B], leftNumeric: ColumnType[A] with NumericColumnType, rightNumeric: ColumnType[B] with NumericColumnType) =
    ColumnTypeEquivalence(left, right)

  implicit def optionOptionNumericEquivalence[A, B](implicit left: ColumnType[Option[A]], right: ColumnType[Option[B]], leftNumeric: ColumnType[A] with NumericColumnType, rightNumeric: ColumnType[B] with NumericColumnType) =
    ColumnTypeEquivalence(left, right)
